...
module.exports = {
   ...
   * @param {function} callback - A callback(err, courseIssues, variant) function.
   */
  _makeUniqueVariant(question, course, options, callback) {
    ...
    function fisheryates(userid, data) { // how to access userid?
      ...
      data["variant_key"] = numbers[variant_id % (upperbound - 1)]; // how to access data and variantid, mod (upperbound - 1) just bandaid before double something
    }
